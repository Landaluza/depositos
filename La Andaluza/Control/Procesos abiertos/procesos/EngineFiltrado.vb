Namespace Procesos
    Public Class EngineFiltrado
        ...
        Private Sub Exportar(sender As Object, e As EventArgs) Implements ProcesoMovimiento.Exportar
            ...
            gui.frmMovimientos.CargarDatos(0, 0, New Date, 0, "", EngineProcesosAbiertos.FILTRACION.ToString, gui.cboDepositoDestino.SelectedValue.ToString, "", "", New Connection.DataBase(Config.Server))
            ...
            If Not gui.cboFiltro.SelectedValue Is Nothing Then gui.frmMovimientos.cbFiltros.SelectedValue = gui.cboFiltro.SelectedValue
