Namespace Procesos
    Public Class EngineLavado
        ...
        Private Sub CargarDatos() Implements ProcesoMovimiento.CargarDatos
            gui.cboDepositoPArtida.mam_DataSource(spLavado.devolver_depositos(), False, False)
        ...
        Private Sub Exportar(sender As Object, e As EventArgs) Implements ProcesoMovimiento.Exportar
            ...
            gui.frmMovimientos.CargarDatos(0, 0, New Date, 0, "", EngineProcesosAbiertos.LAVADO_DEPOSITO.ToString, "", "", "", New Connection.DataBase(Config.Server))
