Public Class SpPieCuba
    ...
    Public Function devolver_lotes() As DataTable
        Return Me.Consultar("select Lotes.LoteID, Lotes.CodigoLote from " & _
                              ...
                              " where usosProductos.ProcesoID = 14 and CantidadRestante > 0", False)
    End Function
    ...
    Public Function actualizar(ByVal destino As Integer, ByVal cantidad As Double, ByVal tlote As Integer, ByVal lote As Integer, ByVal id As Integer) As Boolean
