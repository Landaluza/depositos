Public Class EngineDesembote
    Inherits ProcesosEngine
    Implements ProcesoMovimiento

    Private spDesembote As SpDesembote
    Private gui As frmDesembote
    Public Sub New(ByVal id As Integer, ByRef frm As frmDesembote)
        MyBase.New(id)
        spDesembote = New SpDesembote
        gui = frm
