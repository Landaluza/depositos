Namespace Procesos
    ...
    Public Class EngineDesecho
        Inherits ProcesosEngine
        Implements ProcesoMovimiento

        Private spDesecho As spDesecho
        Private gui As frmDesecho
        Public Sub New(ByVal id As Integer, ByRef frm As frmDesecho)
            MyBase.New(id)
            spDesecho = New spDesecho
            gui = frm
        ...
        Private Sub CargarDatos() Implements ProcesoMovimiento.CargarDatos
            gui.cboRecipiente.mam_DataSource(spDesecho.devolver_recipientes(), False, False)
            gui.cboDepositoPArtida.mam_DataSource(spDesecho.devolver_depositos(), False, False)
        ...
        Private Sub Autoguardado(sender As Object, e As EventArgs) Implements ProcesoMovimiento.Autoguardado
            ...
            spDesecho.actualizar(recipiente, origen, cantidad, id)
        End Sub
        ...
        Private Sub Exportar(sender As Object, e As EventArgs) Implements ProcesoMovimiento.Exportar
            ...
            gui.frmMovimientos.CargarDatos(0, 0, New Date, 0, "", EngineProcesosAbiertos.DESECHO.ToString, gui.cboRecipiente.SelectedValue.ToString, "", "", New Connection.DataBase(Config.Server))
            gui.frmMovimientos.cboProceso.SelectedValue = EngineProcesosAbiertos.DESECHO
