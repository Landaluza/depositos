Namespace Connection
    ...
    Public MustInherit Class StoredProcedure
        ...
        Public Property Database As Connection.DataBase
            Get
                Return dtb
            End Get
            Set(value As Connection.DataBase)
                dtb = value
            End Set
        ...
        Public Sub Select_Record(ByRef dbo As DataBussines, ByRef transactDtb As Connection.DataBase)
            dbo.searchKey.name = dbo.key.name
            dbo.searchKey.value = dbo.key.value
            Me.Select_proc(dbo, selectProcedureName, transactDtb)
        End Sub

        Protected Sub Select_proc(ByRef dbo As DataBussines, ByVal proc As String, ByRef transactDtb As Connection.DataBase)
        ...
        Protected Function InsertProcedure(ByRef dbo As DataBussines, ByRef transactDtb As Connection.DataBase) As Boolean
            Try
                transactDtb.Conectar()
        ...
        Protected Function UpdateProcedure(ByRef dbo As DataBussines, ByRef transactDtb As Connection.DataBase) As Boolean
            Try
                transactDtb.Conectar()
        ...
        Protected Function DeleteProcedure(ByRef dbo As DataBussines, ByRef transactDtb As Connection.DataBase) As Boolean
        ...
        Public Overridable Function Grabar(ByRef dbo As DataBussines, ByRef transactDtb As Connection.DataBase) As Boolean
        ...
        Public MustOverride Function Delete(ByVal id As Integer, ByRef transactDtb As Connection.DataBase) As Boolean
